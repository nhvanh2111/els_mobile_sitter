...
Future<void> showWarningRejectDialog(BuildContext context) async {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Đơn đăng ký của bạn đã bị từ chối\nBạn vui lòng cập nhật lại hồ sơ để sử dụng ứng dụng.',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.roboto(
                  ...
                  Text(
                    'Kiểm tra email hoặc liên hệ với chúng tôi để biết thêm thông tin chi tiết.',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.roboto(
                      color: ColorConstant.gray4A,
                      fontWeight: FontWeight.normal,
