...
Future<void> showConfirmSendFormDialog(
    BuildContext context, String content, PackageBloc packageBloc) async {
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          packageBloc.eventController.sink.add(SaveListPackageEvent(context: context, packageBloc: packageBloc));
