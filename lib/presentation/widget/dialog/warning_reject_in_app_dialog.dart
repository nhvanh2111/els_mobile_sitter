...
Future<void> showWarningRejectInAppDialog(BuildContext context) async {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Kiểm tra email đã đăng ký hoặc liên hệ với chúng tôi để biết thêm thông tin chi tiết.",
                  textAlign: TextAlign.center,
                  style: GoogleFonts.roboto(
                    color: ColorConstant.gray4A,
                    fontWeight: FontWeight.normal,
