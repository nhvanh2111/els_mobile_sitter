...
class AssignSchedulePanel extends StatefulWidget {
  const AssignSchedulePanel({Key? key}) : super(key: key);

  @override
  State<AssignSchedulePanel> createState() => _AssignHistoryPanelState();
}

class _AssignHistoryPanelState extends State<AssignSchedulePanel> {
  ...
  void initState() {
    ...
    _bookingBloc.eventController.sink
        .add(GetAllHistoryByStatusBookingEvent(status: "ASSIGNED"));
