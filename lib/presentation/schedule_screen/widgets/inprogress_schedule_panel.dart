...
class InProgressSchedulePanel extends StatefulWidget {
  const InProgressSchedulePanel({Key? key}) : super(key: key);

  @override
  State<InProgressSchedulePanel> createState() =>
      _InProgressHistoryPanelState();
}

class _InProgressHistoryPanelState extends State<InProgressSchedulePanel> {
