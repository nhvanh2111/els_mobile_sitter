...
Future<void> showConfirmActionBookingDialog(BuildContext context, String content,
    BookingBloc bookingBloc, BookingFullDetailDataModel booking) async {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if(content == "Xác nhận hủy lịch trình"){
                          }
                        },
                      ),
                    ),
